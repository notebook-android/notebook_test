...
//     * @return
//     */
//    public ArrayList<Note> search(String folderName,int Tag,int year,int month ,int day) {           //Tag==0 全部
//
...
//                    if(Tag == 0){
//                        list.add(note);
//                    }else if(Tag == 1 && note.getRemindDate().getYear()==year && note.getRemindDate().getMonth()==month && note.getRemindDate().getDay()==day){
//                        note.setCompareW(true);
//                        list.add(note);
//                        note.setCompareW(false);
//                    }
//                    inputStream.close();
